...
<div class="wrap aipg-wrap">
	<h1 class="aipg-page-title">
		...
		<?php echo $is_edit ? esc_html__( 'Edit Plugin', 'ai-plugin-generator' ) : esc_html__( 'Create New Plugin', 'ai-plugin-generator' ); ?>
	</h1>
	...
	<div class="aipg-create-layout">
				...
				<div class="aipg-card-body">
					<form id="aipg-create-form">
						...
						<div class="aipg-field">
							...
							<input type="text" id="aipg-slug" name="slug" required placeholder="<?php esc_attr_e( 'my-awesome-plugin', 'ai-plugin-generator' ); ?>" <?php echo $is_edit ? 'readonly' : ''; ?>>
							<?php if ( ! $is_edit ) : ?>
						...
						<div class="aipg-actions">
							<button type="submit" class="button button-primary aipg-btn" id="aipg-generate-btn">
								<span class="dashicons dashicons-admin-generic aipg-btn-icon"></span>
								<span class="aipg-btn-text"><?php echo $is_edit ? esc_html__( 'Regenerate Plugin', 'ai-plugin-generator' ) : esc_html__( 'Generate Plugin', 'ai-plugin-generator' ); ?></span>
							</button>
						</div>
					</form>
				</div>
		...
		<div class="aipg-create-preview-panel">
			<div class="aipg-card">
				<div class="aipg-card-header aipg-preview-header">
					<h2><?php esc_html_e( 'Code Preview', 'ai-plugin-generator' ); ?></h2>
					<button type="button" class="button aipg-btn aipg-btn-sm aipg-edit-code-btn" id="aipg-edit-code-btn" style="display:none;" title="<?php esc_attr_e( 'Edit Code', 'ai-plugin-generator' ); ?>">
						<span class="dashicons dashicons-edit"></span>
						<span><?php esc_html_e( 'Edit', 'ai-plugin-generator' ); ?></span>
					</button>
				</div>
				<div class="aipg-card-body aipg-preview-body">
					<!-- Placeholder -->
					...
					<!-- Loading -->
					<div id="aipg-preview-loading" class="aipg-preview-loading" style="display:none;">
						<div class="aipg-loader"></div>
						<p><?php esc_html_e( 'AI is generating your plugin...', 'ai-plugin-generator' ); ?></p>
					</div>

					<!-- File tabs + code -->
					<div id="aipg-preview-content" style="display:none;">
						<div id="aipg-file-tabs" class="aipg-file-tabs"></div>
						<div id="aipg-code-panels" class="aipg-code-panels"></div>
					</div>

					<!-- Actions -->
					<div id="aipg-confirm-actions" class="aipg-actions" style="display:none;">
						<button type="button" class="button button-primary aipg-btn" id="aipg-confirm-btn">
							<span class="dashicons dashicons-yes-alt"></span>
							<span><?php esc_html_e( 'Confirm & Save', 'ai-plugin-generator' ); ?></span>
						</button>
						<button type="button" class="button aipg-btn" id="aipg-regenerate-btn">
							<span class="dashicons dashicons-update"></span>
							<span><?php esc_html_e( 'Regenerate', 'ai-plugin-generator' ); ?></span>
						</button>
					</div>
				</div>
			</div>
